...
oIcons =
{
  ...
  coverEdit : "data:image/png;base64,",
...
function addStyles()
{
  GM_addStyle(
    ...
    ".coverEditButton { display: inline-block; vertical-align: bottom; background-image: url('" + oIcons.coverEdit + "'); right: 5px; top: 5px; }" +
    ...
    ".coverEdit { text-indent: 5px; margin: 1% 0 0 1%; width: 70%; }" +
    ...
    "#sidebar { width: 16%; overflow: auto; padding: 1%; margin-top: 0px !important; margin-right: 16px; float: left}" +
...
function updateSettingsNode()
{
  ...
  with ($("#settings"))
  {
    ...
    find("#trackedSeriesColumnNumberDropdown").val(iTrackedSeriesColumnNumber);
...
function saveSettings()
{
  with ($("#settings"))
  {
    ...
    iTrackedSeriesColumnNumber = find("#trackedSeriesColumnNumberDropdown").val();
    GM_setValue("tracked series column number", iTrackedSeriesColumnNumber);
...
function loadSettings()
{
  ...
  iTrackedSeriesColumnNumber = GM_getValue("tracked series column number", iTrackedSeriesColumnNumber);
